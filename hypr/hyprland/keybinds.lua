...
hl.define_submap("global", function()
  ...
  -- Go to workspace #
  hl.bind(v.kbGoToWs .. " + 1", hl.dsp.exec_cmd(wsaction .. " workspace 1"))
  hl.bind(v.kbGoToWs .. " + 2", hl.dsp.exec_cmd(wsaction .. " workspace 2"))
  hl.bind(v.kbGoToWs .. " + 3", hl.dsp.exec_cmd(wsaction .. " workspace 3"))
  hl.bind(v.kbGoToWs .. " + 4", hl.dsp.exec_cmd(wsaction .. " workspace 4"))
  hl.bind(v.kbGoToWs .. " + 5", hl.dsp.exec_cmd(wsaction .. " workspace 5"))
  hl.bind(v.kbGoToWs .. " + 6", hl.dsp.exec_cmd(wsaction .. " workspace 6"))
  hl.bind(v.kbGoToWs .. " + 7", hl.dsp.exec_cmd(wsaction .. " workspace 7"))
  hl.bind(v.kbGoToWs .. " + 8", hl.dsp.exec_cmd(wsaction .. " workspace 8"))
  hl.bind(v.kbGoToWs .. " + 9", hl.dsp.exec_cmd(wsaction .. " workspace 9"))
  hl.bind(v.kbGoToWs .. " + 0", hl.dsp.exec_cmd(wsaction .. " workspace 10"))

  -- Go to workspace group #
  hl.bind(v.kbGoToWsGroup .. " + 1", hl.dsp.exec_cmd(wsaction .. " -g workspace 1"))
  hl.bind(v.kbGoToWsGroup .. " + 2", hl.dsp.exec_cmd(wsaction .. " -g workspace 2"))
  hl.bind(v.kbGoToWsGroup .. " + 3", hl.dsp.exec_cmd(wsaction .. " -g workspace 3"))
  hl.bind(v.kbGoToWsGroup .. " + 4", hl.dsp.exec_cmd(wsaction .. " -g workspace 4"))
  hl.bind(v.kbGoToWsGroup .. " + 5", hl.dsp.exec_cmd(wsaction .. " -g workspace 5"))
  hl.bind(v.kbGoToWsGroup .. " + 6", hl.dsp.exec_cmd(wsaction .. " -g workspace 6"))
  hl.bind(v.kbGoToWsGroup .. " + 7", hl.dsp.exec_cmd(wsaction .. " -g workspace 7"))
  hl.bind(v.kbGoToWsGroup .. " + 8", hl.dsp.exec_cmd(wsaction .. " -g workspace 8"))
  hl.bind(v.kbGoToWsGroup .. " + 9", hl.dsp.exec_cmd(wsaction .. " -g workspace 9"))
  ...
  hl.bind(v.kbMoveWinToWs .. " + 1", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 1"))
  hl.bind(v.kbMoveWinToWs .. " + 2", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 2"))
  hl.bind(v.kbMoveWinToWs .. " + 3", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 3"))
  hl.bind(v.kbMoveWinToWs .. " + 4", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 4"))
  hl.bind(v.kbMoveWinToWs .. " + 5", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 5"))
  hl.bind(v.kbMoveWinToWs .. " + 6", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 6"))
  hl.bind(v.kbMoveWinToWs .. " + 7", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 7"))
  hl.bind(v.kbMoveWinToWs .. " + 8", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 8"))
  hl.bind(v.kbMoveWinToWs .. " + 9", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 9"))
  hl.bind(v.kbMoveWinToWs .. " + 0", hl.dsp.exec_cmd(wsaction .. " movetoworkspace 10"))

  -- Move window to workspace group #
  hl.bind(v.kbMoveWinToWsGroup .. " + 1", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 1"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 2", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 2"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 3", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 3"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 4", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 4"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 5", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 5"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 6", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 6"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 7", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 7"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 8", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 8"))
  hl.bind(v.kbMoveWinToWsGroup .. " + 9", hl.dsp.exec_cmd(wsaction .. " -g movetoworkspace 9"))
